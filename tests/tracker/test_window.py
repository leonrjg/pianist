...
class TestWindowTracker:
    ...
    @patch('src.core.tracker.window.pywinctl.getAllTitles')
    @patch('src.core.tracker.window.pywinctl.getAllAppsNames')
    ...
    @patch('src.core.tracker.window.pywinctl.getAllTitles')
    @patch('src.core.tracker.window.pywinctl.getAllAppsNames')
    @patch('src.core.tracker.window.logging.error')
    ...
    @patch('src.core.tracker.window.WindowTracker._get_active_windows')
    def test_is_active_true_when_keyword_matches(self, mock_get_windows):
        ...
        with patch('src.core.tracker.window.time.time', return_value=123456789):
    ...
    def test_is_active_false_when_no_keyword_matches(self, mock_get_windows):
        ...
        with patch('src.core.tracker.window.time.time', return_value=1000):
    ...
    def test_is_active_case_insensitive_matching(self, mock_get_windows):
        ...
        with patch('src.core.tracker.window.time.time', return_value=987654321):
            tracker = WindowTracker(['code', 'vim'])
    ...
    def test_is_active_partial_matching(self, mock_get_windows):
        ...
        with patch('src.core.tracker.window.time.time', return_value=555555555):
    ...
    def test_is_active_multiple_keyword_matches(self, mock_get_windows):
        ...
        with patch('src.core.tracker.window.time.time', return_value=111111111):
    ...
    def test_is_active_updates_last_active_as_int(self, mock_get_windows):
        ...
        with patch('src.core.tracker.window.time.time', return_value=123.456):
            tracker = WindowTracker(['code'])
    ...
    def test_empty_keywords_list(self):
        ...
        with patch('src.core.tracker.window.WindowTracker._get_active_windows', return_value=['Any Window']):
            result = tracker.is_active()
